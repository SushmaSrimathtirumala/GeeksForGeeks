package Regular.Arrays.LongestUniqueCharSubString;
...
public class LongestUniqueCharSubString {
    ...
    private static int longestUniqueCharSubString(String str) {
        ...
        return Math.max(max, count); // Note this we have to compare count toward string end at last, before returning
    }
}
