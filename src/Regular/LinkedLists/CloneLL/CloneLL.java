package Regular.LinkedLists.CloneLL;
...
public class CloneLL {
    public static void main(String[] args) {
        ...
        SLLNode clonedHead = cloneLL(head);
    ...
    private static void assignRandomNodesToClones(SLLNode head) {
        while (head != null) {
            // head.random.next will point to clone of original head.random
    ...
    private static void insertClonesAlternatively(SLLNode head) {
        while (head != null) {
            SLLNode cloneNode = new SLLNode(head.val);
